...
#if !defined(DMX_USE_PORT3) && !defined(DMX_USE_PORT1) && defined(USART_RXC_vect)
...
#elif !defined(DMX_USE_PORT3) && !defined(DMX_USE_PORT1) && defined(USART_RX_vect)
...
#elif !defined(DMX_USE_PORT3) && !defined(DMX_USE_PORT1) && defined(USART0_RX_vect)
...
#elif !defined(DMX_USE_PORT3) && (defined(DMX_USE_PORT1) || defined(USART1_RX_vect))
...
#elif defined(DMX_USE_PORT3)
#pragma message "USING USART 3 ON THE ARDUINO MEGA"
// These definitions are used for using serial port 3
